    ...
    return (
      <textarea
        className={cn(
          ...
          // a card: same `bg-transparent`, no shadow, same `ring-2` + offset.
          // They diverged before, and it showed the moment a form sat on a
          // card surface (the textarea alone looked lighter, and lifted).
          // Transparent like the Select trigger: the border-input outline is
          // the field affordance in this system, and a solid fill inside the
          // now-translucent shells was the one rectangle still blocking the

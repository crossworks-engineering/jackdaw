...
export function TeamPortalClient() {
  ...
  return (
    // The §6c composer shell as the page's outer casing (the new-event form
    // treatment): one card, tucked left in the measured pane. The roster is a
    // plain section INSIDE it — a Card here would nest borders two deep.
      ...
      <FormShell className="space-y-6">
        <header className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            without reaching anything you haven&apos;t allowed. It lives outside this app — the
            button below opens it in a new tab so you can see exactly what they see.
          </p>
        </header>
        ...
        <section className="space-y-2 text-sm text-muted-foreground">
          ...
          <p>
            ...
            contact&apos;s page is what creates the role; the token is shown once, so copy it then
            and send it to them yourself.
          </p>
          <p>
            Revoking is the same move in reverse. Delete the token — or the contact — and their
            access ends immediately, mid-session, because every request re-checks that the
            membership is still live.
          </p>
          <p>

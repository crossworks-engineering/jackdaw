      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-xs text-muted-foreground">
            ...
            that never ran it looks healthy yet a feature is dead). Catches the missing object store
            bucket that fails every app build, an unconfigured updater (
            <code>MANTLE_STACK_DIR</code>) that hangs updates, missing secrets, a stray files root,
            a localhost public URL, an unloaded embedder model. Each failure shows the fix — nothing

...
export const MentionList = forwardRef<MentionListHandle, MentionListProps>(function MentionList(
  ...
  return (
    <div
      ...
      className="max-h-[min(18rem,var(--caret-menu-max-h,18rem))] w-64 overflow-y-auto scrollbar-thin scrollbar-hair rounded-xl border border-border bg-popover p-1.5 text-popover-foreground shadow-lg"
    >
      {items.map((item, i) => {

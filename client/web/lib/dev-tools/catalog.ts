  ...
  group('journal', 'Journal', '', [
    {
      ...
      q: [
        { key: 'q' },
        { key: 'lane', description: 'user | agent' },
        { key: 'kind' },
        { key: 'author', description: 'user | agent' },
        { key: 'status', description: 'open | resolved (gaps)' },
        { key: 'tag' },
      ],
    },
    {
      ...
      m: 'POST',
      p: '/api/journal',
      b: '{\n  "title": "House style",\n  "body": "I want terse, no-bullet replies.",\n  "kind": "preference",\n  "tags": []\n}',
    },
    ...
    { n: 'Update entry', m: 'PATCH', p: '/api/journal/{id}', b: '{\n  "kind": "context"\n}' },
    {
      n: 'Resolve gap',
      m: 'POST',
      p: '/api/journal/{id}/resolve',
      b: '{\n  "answer": "We work in Africa/Johannesburg time.",\n  "answerKind": "context"\n}',
    },
